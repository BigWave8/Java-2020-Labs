...
public abstract class AbstractPaperProducts extends AbstractStationery {
	...
	public AbstractPaperProducts(double priceInHryvnia, String producer, String barCode, int targetAge, Format format,
			int article, int densityInGramsPerSguareMeter) {
