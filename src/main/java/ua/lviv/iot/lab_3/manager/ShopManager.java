...
public class ShopManager {
	...
	public static void sortByPrice(List<AbstractStationery> stationeries, SortType sortType) {
		...
		stationeries.sort(sortType == SortType.ASCENDING ? SORT_BY_PRICE : SORT_BY_PRICE.reversed());
	}

	static class SortByPrice implements Comparator<AbstractStationery> {

		@Override
		public int compare(AbstractStationery firstStationery, AbstractStationery secondStationery) {
			return (int) (firstStationery.getPriceInHryvnia() - secondStationery.getPriceInHryvnia());
		}
	...
	public static void sortByBarCode(List<AbstractStationery> stationeries, SortType sortType,
		...
		stationeries.sort(sortType == SortType.ASCENDING ? barCodeComparator : barCodeComparator.reversed());
	}
	...
	public static void sortByTargetAge(List<AbstractStationery> stationeries, SortType sortType) {
		Comparator<AbstractStationery> targetAgeComparator = (firstStationery,
				secondStationery) -> firstStationery.getTargetAge() - secondStationery.getTargetAge();
		stationeries.sort(sortType == SortType.ASCENDING ? targetAgeComparator : targetAgeComparator.reversed());
	}
