...
public class Pencil extends AbstractWritingInstruments {
    ...
    public Pencil(double priceInHryvnia, String producer, String barCode, int targetAge,
            String color, BodyShape bodyShape, BodyColor bodyColor, String bodyMaterial,
            int lineThicknessInMillimeters, boolean canChangeRod, boolean mechanical,
            boolean hasEraser, String hardnessOfState) {
